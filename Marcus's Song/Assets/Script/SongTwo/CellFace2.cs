...
public class CellFace2 : MonoBehaviour
{
    ...
    private CubeManager2 cubeManager;

    void Start()
    {
        rend = GetComponent<Renderer>();
        cubeManager = FindObjectOfType<CubeManager2>();
    ...
    public void Reveal()
    {
        ...
        if (adjacentMines == 0)
        {
            foreach (CellFace2 n in cubeManager.GetNeighborFaces(this))
